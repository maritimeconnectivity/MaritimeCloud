...
public interface BroadcastClient {
    <T extends BroadcastMessage> BroadcastFuture broadcast(T message);

    <T extends BroadcastMessage> BroadcastFuture broadcast(T message, BroadcastSendOptions options);

    // Listen to area, andre options?
