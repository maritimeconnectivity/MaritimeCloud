...
public class BroadcastFutureTest extends AbstractClientConnectionTest {
    ...
    public void broadcastServerAck() throws Exception {
        ...
        BroadcastFuture bf = c.broadcast(new HelloWorld().setMsg("hello"));
        BroadcastPublish mb = t.take(BroadcastPublish.class);
        assertEquals("hello", ((HelloWorld) MessageHelpers.tryRead(mb)).getMsg());
    ...
    public void broadcastClientAcks() throws Exception {
        ...
        BroadcastFuture bf = c.broadcast(new HelloWorld().setMsg("hello"), options);
        BroadcastPublish mb = t.take(BroadcastPublish.class);
        assertEquals("hello", ((HelloWorld) MessageHelpers.tryRead(mb)).getMsg());
        ...
        final BlockingQueue<BroadcastMessageReceived> q = new LinkedBlockingQueue<>();
        ...
        bf.onReceived(new Consumer<BroadcastMessageReceived>() {
