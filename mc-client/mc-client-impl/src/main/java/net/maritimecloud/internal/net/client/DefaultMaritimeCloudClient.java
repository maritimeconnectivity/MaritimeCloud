...
public class DefaultMaritimeCloudClient implements MaritimeCloudClient {
    ...
    private final BroadcastListenOptions broadcastListenOptions;
    ...
    public <T extends BroadcastMessage> BroadcastSubscription broadcastListen(Class<T> messageType,
        ...
        return broadcastListen(messageType, consumer, broadcastListenOptions);
    ...
    @Override
    public <T extends BroadcastMessage> BroadcastSubscription broadcastListen(Class<T> messageType,
            BroadcastListener<T> consumer, BroadcastListenOptions options) {
        return broadcaster.listenFor(messageType, consumer, options);
    }
