...
public class BroadcastPublishAck implements Message, net.maritimecloud.internal.net.messages.spi.ReplyMessage {
     ...
     */
    public static BroadcastPublishAck fromJSON(CharSequence c) {
