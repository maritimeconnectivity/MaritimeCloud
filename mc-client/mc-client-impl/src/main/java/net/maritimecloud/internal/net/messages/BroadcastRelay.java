...
public class BroadcastRelay implements Message, net.maritimecloud.internal.net.messages.spi.ConnectionMessage {
     ...
     */
    public static BroadcastRelay fromJSON(CharSequence c) {
