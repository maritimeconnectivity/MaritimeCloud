...
public class RegisterServiceAck implements Message, net.maritimecloud.internal.net.messages.spi.ReplyMessage {
     ...
     */
    public static RegisterServiceAck fromJSON(CharSequence c) {
