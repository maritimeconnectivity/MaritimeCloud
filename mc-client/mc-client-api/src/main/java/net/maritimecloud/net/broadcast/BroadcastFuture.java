...
public interface BroadcastFuture {
    ...
    /**
     * If {@link BroadcastSendOptions#isReceiverAckEnabled()} is enabled. The specified consumer will be invoked every
     * time a remote party has received the broadcast message.
     *
     * @param consumer
     ...
     */
    void onReceived(Consumer<? super BroadcastMessageReceived> consumer);
