 ...
 */
public class BroadcastSendOptions {
    ...
    public BroadcastSendOptions() {}

    BroadcastSendOptions(BroadcastSendOptions options) {
     ...
     */
    public BroadcastSendOptions immutable() {
     ...
     */
    public BroadcastSendOptions setBroadcastArea(Area area) {
        this.area = area;
        return this;
    }
     ...
     * @return this option object
     */
    public BroadcastSendOptions setBroadcastRadius(int radius) {
     ...
     */
    public BroadcastSendOptions setReceiverAckEnabled(boolean receiverAck) {
        this.receiverAck = receiverAck;
        return this;
    }

    /** An immutable version of BroadcastOptions. */
    static class Immutable extends BroadcastSendOptions {
        /**
         ...
         */
        Immutable(BroadcastSendOptions options) {
            super(options);
        }
