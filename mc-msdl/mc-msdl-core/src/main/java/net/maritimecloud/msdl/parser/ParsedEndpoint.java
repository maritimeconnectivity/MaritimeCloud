...
public class ParsedEndpoint extends AbstractContainer implements EndpointDefinition {
    ...
    final LinkedHashMap<String, ParsedEndpointFunction> byName = new LinkedHashMap<>();
    ...
    public List<EndpointFunction> getFunctions() {
        return (List) Collections.unmodifiableList(new ArrayList<>(byName.values()));
    }
}
