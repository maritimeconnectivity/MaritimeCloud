...
public class MsdlPluginException extends RuntimeException {
    ...
    /**
     * Constructs a new MsdlPluginException with the specified detailed message. The cause is not initialized, and may
     ...
     *            method.
     */
    public MsdlPluginException(String message) {
        super(message);
    }
     ...
     *            method.
     */
    public MsdlPluginException(String message, Throwable cause) {
        super(message, cause);
    }
}
