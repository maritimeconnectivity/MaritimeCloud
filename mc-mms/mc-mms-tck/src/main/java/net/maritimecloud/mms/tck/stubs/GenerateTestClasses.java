...
public class GenerateTestClasses {
    public static void main(String[] args) {
        ...
        // g.setSourceDirectory(Paths.get("mc-mms-tck/src/main/msdl/"));
        // g.addDependencyDirectory(Paths.get("mc-mms-tck/src/main/msdl/"));
        // g.addFile("stubs.msdl");
        // g.addPlugin(JavaGenPlugin.create("mc-mms-tck/src/main/java"));
        // g.executePlugins();
    }
}
