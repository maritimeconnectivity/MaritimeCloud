...
public class OldDefaultServerEndpoint {

    /** The connection is attached to, or null, if it is not attached to one. */
    private volatile OldServerTransport transport;

    /** A factory for creating server transports. */
    private final Supplier<OldServerTransport> transportFactory;

    public OldDefaultServerEndpoint(Supplier<OldServerTransport> transportFactory) {
