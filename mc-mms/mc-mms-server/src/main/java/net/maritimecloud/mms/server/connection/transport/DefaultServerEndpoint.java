...
public class DefaultServerEndpoint {
    ...
    private final Supplier<ServerTransportListener> transportFactory;

    public DefaultServerEndpoint(Supplier<ServerTransportListener> transportFactory) {
    ...
    public void onOpen(Session session) {
        ...
        transport = new ServerTransport(session, transportFactory.get());
